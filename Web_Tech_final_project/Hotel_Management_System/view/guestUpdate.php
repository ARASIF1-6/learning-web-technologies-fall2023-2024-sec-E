...
<body>
    <table border = '1' width = 100%>
        ...
        <tr>
            ...
            <td width = 85%>
                <form method="post" action="../controller/guestUpdateCheck.php" enctype="">
                    <fieldset align = "center">
                        <legend> Update Guest </legend>
                        Name: <input type="text" name="name" value="<?=$guest['GuestName']?>" /> <br> <br>
                        Email: <input type="email" name="email" value="<?=$guest['GuestEmail']?>" /> <br> <br>
                        Mobile Number: <input type="tel" name="number" value="<?=$guest['GuestNumber']?>" /> <br> <br>
                        ...
                        Username: <input type="text" name="username" value="<?=$guest['GuestUserName']?>" readonly /> <br> <br>
